								...
								<div class="row">
									<div class="col-lg-12">
										...
										<div class="row" id="btn_change_info">
														...
														<a href="Update_thongtin_GV.jsp?username=${dangnhap.userName}" style="color: white;text-decoration: none;margin: 5px 0px 0px 17px;">
								...
								<div class="row">
									<div class="col-lg-12 ">
										<form class="form-horizontal" method="post" action="Doi_MK">
											...
											<button type="submit" id="btn_tao" class="btn btn-success" style="float: right;">Đổi mật khẩu</button> 
	...
	$(document).ready(function(){
		...
		function check_form_diachi(){
			...
			if(diachi_lenght == 0){
				...
				$("#diachi_error_message").html("Chưa nhập <br> địa chỉ!");
		...
		function check_form_dienthoai(){
			var dienthoai_lenght= $('#form_dienthoai').val().length;
			if(dienthoai_lenght == 0){
				
				$("#dienthoai_error_message").html("Chưa nhập số<br> điện thoại!");
		...
		function check_form_email(){
			...
			if(pattern.test($("#form_email").val())){
				...
				$("#email_error_message").html("Chưa nhập email!");
