		...
		<div class="row" id="menutop">
			...
			<div class="col-lg-12">
				...
				<ul>
					...
					int idSupport=GV_DuAnMoi_DAO.getIdSupportByUserName(username);
					total=GV_DuAnMoi_DAO.countDeTai(username);
					if(total<=3){
						firstResult=1;
						maxResult=total;
					}else{
					...
					ArrayList<Admin_CapPhepDeTai> listDT=GV_DuAnMoi_DAO.getListCapDTByNav(firstResult, maxResult,username);
										 ...
										 %> 
											...
											<tr>
												...
												<td><a href="" data-toggle="modal"
													data-target="#Modal_thongtin_detai"> <%=//out.print(capphep.getString(2));
													list.getNameSub()%></a>
												</td>
												...
												<td>
													 <a href="GV_DuyetDT_SV.jsp?username=<%=username %>&idSub=<%=list.getIdSub()%>&idAcc=<%=list.getIdAcc()%>"><span
					...
					<div class="col-lg-12">
						<div id="Control_next_prev">
							...
							<%for(int i=1; i<=(total/3)+1; i++){%>
								<a href="ThongBaoCapPhep_GV.jsp?username=<%=username %>&pages=<%=i%>"><%=i %></a>
							<% }
							%>
