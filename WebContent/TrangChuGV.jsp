				...
				<header>
					...
					<li><a href="#">Nghiên cứu</a></li>
							...
							<li id="logout"><a href="#"><span
									class="glyphicon glyphicon-user"></span> ${dangnhap.nameTea} <br /></a></li>
				...
				<div class="row">
					<div class="col-lg-12">
						<div id="ND_thongtinmoi">
							...
							<strong><a class="hover_red" href="GV_DangKyDTai.jsp?username=${dangnhap.userName}" >Đến trang giảng viên đăng ký đề tài</a></strong>
							...
							<p>Sinh viên vui lòng xem thông tin chi tiết <a class="taiday" href="GV_DangKyDTai.jsp?username=${dangnhap.userName}">tại đây</a></p>
							<p class="text-right hidden-xs" ><a class="chitiet" href="GV_DangKyDTai.jsp?username=${dangnhap.userName}" style="text-decoration: none; padding-right: 100px"  ><i class="fa fa-hand-o-right" style="padding: 2px"></i>chi tiết</a></p>

							<strong><a class="hover_red" href="GV_NopDeTai.jsp?username=${dangnhap.userName}" >Giảng viên nộp đề tài tại đây</a></strong>
							<p class="date_time">[Ngày đăng:16/10/2017 10:37:00 AM]</p>	 
							
							<p>Sinh viên vui lòng xem thông tin chi tiết <a class="taiday" href="GV_NopDeTai.jsp?username=${dangnhap.userName}">tại đây</a></p>	  			 		
							<p class="text-right hidden-xs" ><a class="chitiet" href="GV_NopDeTai.jsp?username=${dangnhap.userName}" style="text-decoration: none; padding-right: 100px"  ><i class="fa fa-hand-o-right" style="padding: 2px"></i>chi tiết</a></p>

							<strong><a class="hover_red" href="GV_ThongBaoDuAnMoi.jsp?username=${dangnhap.userName}" >Danh sách các đề tài chờ duyệt</a></strong>
							<p class="date_time">[Ngày đăng:16/10/2017 10:37:00 AM]</p>	 
							<!--<img src="../Image/nieuw.gif" style="width: 40px;height: 30px; display: block; margin-left: 50px;">-->
							<p>Sinh viên vui lòng xem thông tin chi tiết <a class="taiday" href="GV_ThongBaoDuAnMoi.jsp?username=${dangnhap.userName}">tại đây</a></p>
							<p class="text-right hidden-xs" ><a class="chitiet" href="GV_ThongBaoDuAnMoi.jsp?username=${dangnhap.userName}" style="text-decoration: none; padding-right: 100px"  ><i class="fa fa-hand-o-right" style="padding: 2px"></i>chi tiết</a></p>
